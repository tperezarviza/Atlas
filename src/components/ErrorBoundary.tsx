  ...
  render() {
    if (this.state.hasError) {
      return (
        ...
        >
          <div
            className="max-w-[500px] rounded-[3px] p-6"
            style={{ background: '#0b1224', border: '1px solid #14233f' }}
          >
            ...
            <div
              ...
              style={{ background: 'rgba(232,59,59,.06)', border: '1px solid rgba(232,59,59,.15)' }}
            >
