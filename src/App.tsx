...
export default function App() {
  ...
  // Lifted: single source of truth for conflicts — shared by WorldMap and ConflictList
  const { data: conflicts, error: conflictsError } = useAutoRefresh<Conflict[]>(api.conflicts, 60_000)
