...
export const mockShipping: Chokepoint[] = [
  {
    ...
    nearbyVessels: null, recentIncidents: ['Iranian seizure of tanker (Jan 2025)'],
  },
  {
    ...
    nearbyVessels: null, recentIncidents: ['Houthi drone strike on bulk carrier'],
  },
  {
    id: 'cp-suez', name: 'Suez Canal', lat: 30.46, lng: 32.34, region: 'Middle East',
    dailyVessels: 50, oilFlowMbpd: 5.5, globalTradePercent: 12,
    status: 'disrupted', statusReason: 'Traffic down 50% due to Red Sea crisis',
  ...
  },
  {
    ...
    status: 'normal', nearbyVessels: null, recentIncidents: [],
  },
  {
    ...
    status: 'elevated', statusReason: 'PLA Navy exercises',
