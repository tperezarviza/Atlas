...
const FEED_SOURCES: FeedSource[] = [
  ...
  { url: 'https://rsshub.app/apnews/topics/world-news',
    flag: '🇺🇸', handle: 'AP', role: 'Associated Press Wire',
    sourceName: 'AP News', category: 'leader', tags: ['News', 'Wire'], tier: 2 },
  { url: 'https://www.theguardian.com/world/rss',
    flag: '🇬🇧', handle: 'Guardian', role: 'UK Quality Broadsheet',
    sourceName: 'The Guardian', category: 'leader', tags: ['News', 'UK'], tier: 2 },
  { url: 'https://kyivindependent.com/feed/',
    flag: '🇺🇦', handle: 'KyivIndep', role: 'Ukraine Independent News',
    sourceName: 'Kyiv Independent', category: 'leader', tags: ['Ukraine', 'War'], tier: 2 },
  { url: 'https://www.scmp.com/rss/91/feed',
    flag: '🇭🇰', handle: 'SCMP', role: 'South China Morning Post',
    sourceName: 'SCMP', category: 'leader', tags: ['China', 'Asia'], tier: 2 },
  { url: 'https://www.haaretz.com/cmlink/1.628765',
    flag: '🇮🇱', handle: 'Haaretz', role: 'Israeli Liberal Broadsheet',
    sourceName: 'Haaretz', category: 'leader', tags: ['Israel', 'News'], tier: 2 },
  { url: 'https://www.arabnews.com/rss.xml',
    flag: '🇸🇦', handle: 'ArabNews', role: 'Saudi English News',
    sourceName: 'Arab News', category: 'leader', tags: ['Saudi', 'Middle East'], tier: 2 },
