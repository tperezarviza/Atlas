...
const CACHE_KEYS = [
  ...
  'congress_bills', 'congress_nominations', 'executive_orders', 'polling', 'flights', 'ukraine_front',
  'twitter', 'cyber_threats', 'cyber_infra', 'satellite', 'natural_events', 'economic_calendar', 'alerts',
  'earthquakes',
  'unsc_calendar',
];
...
const SERVICE_META: Record<string, { name: string; category: string }> = {
  ...
  polling: { name: 'Polling Data', category: 'Domestic' },
  ...
  cyber_infra: { name: 'Infrastructure Exposure', category: 'Cyber' },
  satellite: { name: 'Satellite Imagery', category: 'Intelligence' },
